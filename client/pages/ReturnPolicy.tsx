        ...
        <div className="space-y-8">
          <section>
            ...
            <p className="font-jakarta text-[16px] text-[#7E7E7E] leading-relaxed">
              At The Activerse, we want you to be completely satisfied with your
              purchase. If you're not happy with your order, we offer a
              hassle-free return process. Please review our return policy below
              to understand how to return items and what our conditions are.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="font-jakarta text-[16px] text-[#7E7E7E] leading-relaxed">
              ...
              a return. Items must be unworn, unwashed, and in their original
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 font-jakarta text-[16px] text-[#7E7E7E]">
              <li>
                We'll inspect the item to ensure it meets our return conditions
              </li>
              <li>
                If approved, your refund will be processed within 5-10 business
                days
              </li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 font-jakarta text-[16px] text-[#7E7E7E]">
              ...
              <li>
                Items purchased from third-party vendors (contact vendor
                directly)
              </li>
          ...
          <section>
            ...
            <p className="font-jakarta text-[16px] text-[#7E7E7E] leading-relaxed">
              ...
              us at info@theactiverse.com or call 800# for assistance.
            </p>
          </section>
        </div>
      </div>
